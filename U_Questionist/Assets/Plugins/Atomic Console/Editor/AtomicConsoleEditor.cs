...
namespace AtomicConsole.Engine.editor
{
    ...
    public class AtomicConsoleEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUI.enabled = false;
            EditorGUILayout.ObjectField("Selected Skin", devConsole.skin, typeof(AtomicSkin), false,
                GUILayout.Height(20));
            GUI.enabled = true;
            ...
            devConsole.password_Protected =
                EditorGUILayout.ToggleLeft("Enable Password Protection", devConsole.password_Protected);

            if (devConsole.password_Protected)
            {
                EditorGUILayout.BeginHorizontal();
                string newPassword = showPassword
                    ? EditorGUILayout.TextField("Password", devConsole.password)
                    : EditorGUILayout.PasswordField("Password", devConsole.password);
                ...
                {
                    statusMessage = "Updated";
                    EditorGUILayout.LabelField($"To unlock protected commands, type in console:",
                        EditorStyles.centeredGreyMiniLabel);
                    EditorGUILayout.LabelField(
                        $"[Command] '>>'  Your Password:{new string('*', devConsole.password.Length)}",
                        EditorStyles.centeredGreyMiniLabel);
                    EditorGUILayout.Space(5);
                    EditorGUILayout.LabelField("", GUI.skin.horizontalSlider);
                    EditorGUILayout.Space(5);
            ...
            devConsole.ToggleConsoleInput =
                (KeyCode)EditorGUILayout.EnumPopup("Toggle Console Input", devConsole.ToggleConsoleInput);
            ...
            GUIContent supportLabel3 = new GUIContent(" Warning",
